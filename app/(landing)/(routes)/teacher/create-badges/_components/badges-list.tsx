  ...
  return (
    <div className="flex flex-wrap justify-center">
      {badges.map((badge: Badge) => (
        <div
          key={badge.id}
          className="badgeshadow m-4 text-center flex flex-col items-center mr-4  transition ease-in-out delay-100 hover:cursor-pointer hover:shadow-lg hover:-translate-y-1 hover:scale-105   rounded-lg p-2    bg-gradient-to-tr from-amber-200 to-yellow-500    border border-red-400"
