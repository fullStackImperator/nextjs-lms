...
import { $isTableSelection, TableSelection } from '../../nodes/TableNode/types'
...
export function TreeView({
  ...
  return (
    <AppBar
      ...
      sx={{ position: 'relative', displayPrint: 'none' }}
    >
      ...
      {(showLimited || !isLimited) && (
        <pre
          style={{ overflow: 'auto', margin: 0, padding: '0.5rem' }}
          ref={treeElementRef}
        >
          {content}
        </pre>
