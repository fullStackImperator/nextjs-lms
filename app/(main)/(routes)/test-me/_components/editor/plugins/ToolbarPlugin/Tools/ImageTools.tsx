...
import { $isSketchNode, SketchNode } from '../../../nodes/SketchNode/SketchNode'
...
import { $isIFrameNode, IFrameNode } from '../../../nodes/IFrameNode/IFrameNode'
...
export default function ImageTools({
  ...
  return (
    <ToggleButtonGroup size="small" sx={{ ...sx }}>
      ...
      {!$isSketchNode(node) && !$isIFrameNode(node) && (
        <ToggleButton value="sketch" key="sketch" onClick={openSketchDialog}>
          <Draw />
        </ToggleButton>
      )}
      <ToggleButton
      ...
      <ToggleButton
        value="float-none"
        key="float-none"
        selected={!style || style?.float === 'none'}
        onClick={() => {
