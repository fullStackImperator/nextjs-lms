...
function ToolbarPlugin() {
  ...
  const toolboxOverflow =
    toolbarDimensions.width && toolboxDimensions.width
      ? toolboxDimensions.width + 168 > toolbarDimensions.width
      : false
    ...
    <>
      ...
      >
        <Toolbar
          ...
          sx={{
            displayPrint: 'none',
            px: `${toolbarTrigger ? 1 : 0}!important`,
            display: 'grid',
        ...
        >
          ...
          <Box
            sx={{
              ...
              gap: 0.5,
              mx: 'auto',
              gridColumn: toolboxOverflow ? '1/-1' : 'auto',
            }}
            ref={toolboxRef}
          >
            {showMathTools && (
          ...
          {SUPPORT_SPEECH_RECOGNITION && (
            <Fab
              size="small"
              color={isSpeechToText ? 'secondary' : 'primary'}
              sx={{
                position: 'fixed',
      ...
      {toolbarTrigger && (
        <Box
          sx={(theme) => ({ ...theme.mixins.toolbar, displayPrint: 'none' })}
        />
      )}
      <ImageDialog
        editor={activeEditor}
