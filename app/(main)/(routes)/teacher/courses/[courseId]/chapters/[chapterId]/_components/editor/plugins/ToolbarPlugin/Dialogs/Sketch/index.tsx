...
function SketchDialog({
  ...
  const handleSubmit = async () => {
    ...
    const exportToSvg = await import(
      ...
      .then((module) => module.exportToSvg)
  ...
  const loadSceneOrLibrary = async () => {
    ...
    try {
      ...
      const MIME_TYPES = await import(
        '@excalidraw/excalidraw/dist/excalidraw.production.min.js'
      ).then((module) => module.MIME_TYPES)
      const getSceneVersion = await import(
        '@excalidraw/excalidraw/dist/excalidraw.production.min.js'
      ).then((module) => module.getSceneVersion)
      if ($isSketchNode(node)) {
