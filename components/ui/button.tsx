  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        game_primaryOutline: 'bg-white text-sky-500 hover:bg-slate-100 ',
        game_secondary:
          'bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0',
        game_secondaryOutline: 'bg-white text-green-500 hover:bg-slate-100 ',
        game_danger:
          'bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0',
        game_dangerOutline: 'bg-white text-rose-500 hover:bg-slate-100 ',
        game_super:
          'bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border-b-0',
        game_superOutline: 'bg-white text-indigo-500 hover:bg-slate-100 ',
        game_ghost:
